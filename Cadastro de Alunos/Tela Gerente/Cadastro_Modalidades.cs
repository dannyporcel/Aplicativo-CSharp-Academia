        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
			...
			else
			{
				try
				{
					...
					comando.CommandText = "insert into tbl_Modalidade(nomeModal,descricaoModal,dataCadastro,modalSituacao) values " +
						"('" + txtNome.Text + "','" + txtDescricao.Text + "','"+data+"','"+"Ativo"+"')"; /*datanasc.ToString("yyyy-MM-dd")*/
