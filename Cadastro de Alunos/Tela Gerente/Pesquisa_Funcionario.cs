...
namespace Cadastro_de_Alunos
{
    public partial class Pesquisa_Funcionario : Form
    {
		...
		public void populateDGV()
		{
                ...
                string selectQuery = "SELECT nomeFuncionario ,CPF,RG,dataNasc,Sexo,Logradouro,Complemento,numEndereco,Bairro,Cidade,UF,CEP,DDD1,telefone,DDD2,telefone_2,Email,Cargo,ID_Funcionario FROM tbl_Funcionario";
        ...
        private void Pesquisa_Funcionario_Load(object sender, EventArgs e)
        {
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["conn"].ConnectionString))
            {
                if (conn.State == ConnectionState.Closed)
                    conn.Open();
                using (SqlDataAdapter da = new SqlDataAdapter("SELECT nomeFuncionario ,CPF,RG,dataNasc,Sexo,Logradouro,Complemento,numEndereco,Bairro,Cidade,UF,CEP,DDD1,telefone,DDD2,telefone_2,Email,Cargo,ID_Funcionario FROM tbl_Funcionario", conn))
                {
        ...
        private void rdGerente_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                DataView dv = dt.DefaultView;
                dv.RowFilter = string.Format("Cargo like 'Gerente'", rdGerente.Text);
                dgPesquisaFunc.DataSource = dv.ToTable();
        ...
        private void rdAtendente_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                DataView dv = dt.DefaultView;
                dv.RowFilter = string.Format("Cargo like 'Atendente'", rdAtendente.Text);
                dgPesquisaFunc.DataSource = dv.ToTable();
            }
        }
		...
		{
			txtNomeEditar.Text = dgPesquisaFunc.CurrentRow.Cells[0].Value.ToString();			
			mskCpf.Text = dgPesquisaFunc.CurrentRow.Cells[1].Value.ToString();
			txtRG.Text = dgPesquisaFunc.CurrentRow.Cells[2].Value.ToString();
			mskDataNascimento.Text = dgPesquisaFunc.CurrentRow.Cells[3].Value.ToString();
			cbxSexo.Text = dgPesquisaFunc.CurrentRow.Cells[4].Value.ToString();
			txtLogradouro.Text = dgPesquisaFunc.CurrentRow.Cells[5].Value.ToString();
			txtComplemento.Text = dgPesquisaFunc.CurrentRow.Cells[6].Value.ToString();
			txtNumero.Text = dgPesquisaFunc.CurrentRow.Cells[7].Value.ToString();
			txtBairro.Text = dgPesquisaFunc.CurrentRow.Cells[8].Value.ToString();
			txtCidade.Text = dgPesquisaFunc.CurrentRow.Cells[9].Value.ToString();
			cbxUF.Text = dgPesquisaFunc.CurrentRow.Cells[10].Value.ToString();
			txtCEP.Text = dgPesquisaFunc.CurrentRow.Cells[11].Value.ToString();
			txtDDD1.Text = dgPesquisaFunc.CurrentRow.Cells[12].Value.ToString();
			txtTelefone.Text = dgPesquisaFunc.CurrentRow.Cells[13].Value.ToString();
			txtDDD2.Text = dgPesquisaFunc.CurrentRow.Cells[14].Value.ToString();
			txtTelefone2.Text = dgPesquisaFunc.CurrentRow.Cells[15].Value.ToString();
			txtEmail.Text = dgPesquisaFunc.CurrentRow.Cells[16].Value.ToString();
			if(dgPesquisaFunc.CurrentRow.Cells[17].Value.ToString()== "Atendente")
			{
            ...
            txtID.Text = dgPesquisaFunc.CurrentRow.Cells[18].Value.ToString();
        }
