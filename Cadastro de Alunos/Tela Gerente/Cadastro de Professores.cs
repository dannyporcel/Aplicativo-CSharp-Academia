    ...
    public partial class Cadastro_de_Professores : Form
    {
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                comando.CommandText = "insert into tbl_Professor(nomeProfessor,Sexo,Logradouro,numEndereco,UF,Cidade,telefone,RG,CEP,Bairro,Email,regCREF,CPF,DDD1,DDD2,telefone_2,dataNasc,Complemento,dataCadastro,Senha,Foto) values ('"
                    ...
                    + Convert.ToDateTime(mskDataNascimento.Text) + "','" + txtComplemento.Text + "','"+data+"','" + Senha + "',@IMG)";
