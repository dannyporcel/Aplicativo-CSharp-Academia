...
namespace Cadastro_de_Alunos
{
    public partial class Pesquisa_Modalidade : Form
    {
        ...
        {
            if (dgPesquisaModal.CurrentRow != null)
            {
            ...
            else
            {
                try
                {
                    ...
                    string updateQuery = "UPDATE tbl_modalidade SET nome_modal='" + txtNomeEditar.Text +
                                        ...
                                        "WHERE id_modalidade=" + int.Parse(txtID.Text);
                    executeMyQuery(updateQuery);
                    populateDGV();
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Falha ao atualizar a modalidade: " + ex.Message, "Ops", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtNomeEditar.Clear();
                    txtDescricao.Clear();
                }
