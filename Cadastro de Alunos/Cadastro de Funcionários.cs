    ...
    public partial class Cadastro_de_Funcionários : Form
    {
     ...
     void carregaLista()
     {
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
			...
			else if(rbAtendente.Checked == false && rbGerente.Checked == false)
			{
            ...
            try
            {
                ...
                comando.CommandText = "insert into tbl_Funcionario(nomeFuncionario,Sexo,Logradouro,numEndereco,UF,Cidade,Telefone,RG,CEP,Bairro,Email,Complemento,CPF,DDD1,DDD2,Telefone2,funcSituacao,dataNasc,Senha,Foto) values ('"
                    ...
                    + Convert.ToDateTime(mskDataNascimento.Text) + "','" + txtSenha.Text + "',@IMG)";
