...
{
    public partial class Pesquisa_Alunos : Form
    {
		...
		{
			string selectQuery = "SELECT  ID_Aluno,nomeAluno,alSituacao,CPF,RG,dataNasc,Genero,Logradouro,Complemento,numEndereco,Bairro,Cidade,UF,CEP,DDD1,Telefone,DDD2,Telefone2,Email,Foto from tbl_Aluno";
        ...
        private void btnLimpar_Click(object sender, EventArgs e)
        {
            ...
            txtCPF.Clear();
            txtNome.Focus();
            dgPesquisaAluno.DataSource = null;

        }

        private void Pesquisa_Alunos_Load(object sender, EventArgs e)
        {
		...
		{
			txtNomeEditar.Text = dgPesquisaAluno.CurrentRow.Cells[1].Value.ToString();
			mskCPF.Text = dgPesquisaAluno.CurrentRow.Cells[3].Value.ToString();
			txtRG.Text = dgPesquisaAluno.CurrentRow.Cells[4].Value.ToString();
			mskDataNasc.Text = dgPesquisaAluno.CurrentRow.Cells[5].Value.ToString();
			cbxSexo.Text = dgPesquisaAluno.CurrentRow.Cells[6].Value.ToString();
			txtLogradouro.Text = dgPesquisaAluno.CurrentRow.Cells[7].Value.ToString();
			txtComplemento.Text = dgPesquisaAluno.CurrentRow.Cells[8].Value.ToString();
			txtNumero.Text = dgPesquisaAluno.CurrentRow.Cells[9].Value.ToString();
			txtBairro.Text = dgPesquisaAluno.CurrentRow.Cells[10].Value.ToString();
			txtCidade.Text = dgPesquisaAluno.CurrentRow.Cells[11].Value.ToString();
			cbxUF.Text = dgPesquisaAluno.CurrentRow.Cells[12].Value.ToString();
			txtCEP.Text = dgPesquisaAluno.CurrentRow.Cells[13].Value.ToString();
			txtDDD1.Text = dgPesquisaAluno.CurrentRow.Cells[14].Value.ToString();
			txtTelefone.Text = dgPesquisaAluno.CurrentRow.Cells[15].Value.ToString();
			txtDDD2.Text = dgPesquisaAluno.CurrentRow.Cells[16].Value.ToString();
			txtTelefone2.Text = dgPesquisaAluno.CurrentRow.Cells[17].Value.ToString();
			txtEmail.Text = dgPesquisaAluno.CurrentRow.Cells[18].Value.ToString();
			txtID.Text = dgPesquisaAluno.CurrentRow.Cells[0].Value.ToString();
			if (dgPesquisaAluno.CurrentRow.Cells[2].Value.ToString() == "Ativo")
			{
